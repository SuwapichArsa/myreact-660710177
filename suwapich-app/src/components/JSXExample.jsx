        ...
        <div className="jsx-examples">
            ...
            <section>
                ...
                <div className="product-list">
                    <h3>รายการสินค้า</h3>
                    {[
                        { id: 1, name: 'iPhone', price: 48900, inStock: true },
                        { id: 2, name: 'MacBook', price: 38900, inStock: true },
                        { id: 3, name: 'Apple Watch', price: 14900, inStock: false }
                    ].map(product => (
